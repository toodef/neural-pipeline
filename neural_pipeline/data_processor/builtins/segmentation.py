...
def resnet18(classes_num: int, in_channels: int, pretrained: bool = True):
    ...
    return UNetModel(model, classes_num, weights_url=model_urls['resnet18'] if pretrained else None)
...
def resnet34(classes_num: int, in_channels: int, pretrained: bool = True):
    ...
    return UNetModel(model, classes_num, weights_url=model_urls['resnet34'] if pretrained else None)
...
def resnet50(classes_num: int, in_channels: int, pretrained: bool = True):
    ...
    return UNetModel(model, classes_num, weights_url=model_urls['resnet50'] if pretrained else None)
...
def resnet101(classes_num: int, in_channels: int, pretrained: bool = True):
    ...
    return UNetModel(model, classes_num, weights_url=model_urls['resnet101'] if pretrained else None)
...
def resnet152(classes_num: int, in_channels: int, pretrained: bool = True):
    ...
    return UNetModel(model, classes_num, weights_url=model_urls['resnet152'] if pretrained else None)
